<script lang="ts">
	 ...
	 * Phase 2 will swap the action handler to local scrypt sessions.
	 */
...
<div class="flex min-h-screen items-center justify-center px-4 py-12">
	<div class="w-full max-w-md">
		...
		<div class="rounded-lg border border-border bg-surfaceMid p-8">
			...
			>
				...
				<div class="flex items-center justify-between">
					<a href={resolve('/auth/forgot-password')} class="text-sm text-accent1 hover:underline">
		...
		<p class="mt-6 text-center text-sm text-secondary">
			...
			<a href={resolve('/auth/register')} class="text-accent1 hover:underline">
