...
- **Publisher**: DavidPM
- **Website**: ${SITE_ORIGIN}
- **Tagline**: Build once. Own forever.
...
- **What's not included**: Implementation services, coaching, ongoing support (the customer owns and operates the system)
...
1. **Autonomy through ownership** — Self-hosted perpetual license, source code access, no vendor dependency, full customization rights
...
A: No. Primer is sold as a perpetual source code license. Customers receive the complete source code, deploy it on their own infrastructure, and own it outright. No subscriptions, no per-seat fees, no ongoing vendor dependency.
...
A: Yes. The code is yours. Modify it, add features, change branding, integrate it with existing systems, extend it however you see fit.

**Q: Do you offer ongoing support?**
A: No, by design. Ongoing support requires vendor access to customer systems, which reintroduces the data exposure and dependency that the perpetual license model eliminates. The code is yours — you operate it, maintain it, and modify it.
...
**Q: Who is Primer for?**
A: Organizations that want to own their performance management tooling outright. If you have the technical capacity to deploy and maintain a web application, you can operate Primer.
