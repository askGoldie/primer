...
DavidPM builds and licenses Primer. The team operates a live demo at ${SITE_ORIGIN} but the product itself is delivered as a downloadable source code package — customers own and operate it independently.
...
Organizations of 50–1,000+ people that want to **own** their performance management tooling instead of renting it. Common industries: construction, healthcare, professional services, manufacturing, retail. Common roles using it: CEOs, VPs, team leads, managers, HR, individual contributors.
