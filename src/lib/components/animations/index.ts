 ...
 *
 * Lightweight animation components using Svelte's built-in
 * transition and motion primitives. No external dependencies.
 *
 * AnimatedGradientText and Marquee adapted from animation-svelte library
